...
<p align="center">You can also use it on Firefox\n To use this Firefox Add-On, download the zip file and extract it, navigate to <code>about:debugging</code> and press <code>Load Temporary Add-On...</code>, select the <code>manifest.json</code> (or just Manifest depending on settings). Open a new tab and enjoy.</p>
